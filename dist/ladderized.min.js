...
(function(root){"use strict";var css=".nanobar{width:100%;height:4px;z-index:9999;top:0}.bar{width:0;height:100%;transition:height .3s;background:#000}";function addCss(){var s=document.getElementById("nanobarcss");if(s===null){s=document.createElement("style");s.type="text/css";s.id="nanobarcss";document.head.insertBefore(s,document.head.firstChild);if(!s.styleSheet)return s.appendChild(document.createTextNode(css));s.styleSheet.cssText=css}}function addClass(el,cls){if(el.classList)el.classList.add(cls);else el.className+=" "+cls}function createBar(rm){var el=document.createElement("div"),width=0,here=0,on=0,bar={el:el,go:go};addClass(el,"bar");function move(){var dist=width-here;if(dist<.1&&dist>-.1){place(here);on=0;if(width===100){el.style.height=0;setTimeout(function(){rm(el)},300)}}else{place(width-dist/4);setTimeout(go,16)}}function place(num){width=num;el.style.width=width+"%"}function go(num){if(num>=0){here=num;if(!on){on=1;move()}}else if(on){move()}}return bar}function Nanobar(opts){opts=opts||{};var el=document.createElement("div"),applyGo,nanobar={el:el,go:function(p){applyGo(p);if(p===100){init()}}};function rm(child){el.removeChild(child)}function init(){var bar=createBar(rm);el.appendChild(bar.el);applyGo=bar.go}addCss();addClass(el,"nanobar");if(opts.id)el.id=opts.id;if(opts.classname)addClass(el,opts.classname);if(opts.target){el.style.position="relative";opts.target.insertBefore(el,opts.target.firstChild)}else{el.style.position="fixed";document.getElementsByTagName("body")[0].appendChild(el)}init();return nanobar}if(typeof exports==="object"){module.exports=Nanobar}else if(typeof define==="function"&&define.amd){define([],function(){return Nanobar})}else{root.Nanobar=Nanobar}})(this);var ladderized=function(){var o={classname:"ladderized-nanobar",id:"ladderized-nanobar",target:document.body},e=new Nanobar(o),t=0,r=10;this.showNanoBar=function(){return r=10,e.go(r),this};var n=[];this.queue=n,this.clearQueue=function(){return n=[],t=0,r=10,this},this.parallel=function(o){return t++,"object"!=typeof o&&console.log("error","expecting OBJECT on PARALLEL"),n.push({type:"parallel",entries:o}),this},this.js=function(o){return t++,"object"!=typeof o&&console.log("error","expecting OBJECT on JS"),!1===Object.prototype.hasOwnProperty.call(o,"link")&&console.log("error","expecting LINK PROPERTY on JS"),n.push({type:"js",entry:o}),this},this.css=function(o){return t++,"object"!=typeof o&&console.log("error","expecting OBJECT on CSS"),!1===Object.prototype.hasOwnProperty.call(o,"link")&&console.log("error","expecting LINK PROPERTY on CSS"),n.push({type:"css",entry:o}),this},this.resource=function(o){return t++,"object"!=typeof o&&console.log("error","expecting OBJECT on RESOURCE"),!1===Object.prototype.hasOwnProperty.call(o,"name")&&console.log("error","expecting NAME PROPERTY on RESOURCE"),!1===Object.prototype.hasOwnProperty.call(o,"link")&&console.log("error","expecting LINK PROPERTY on RESOURCE"),n.push({type:"resource",entry:o}),this};var c={};this.resources=c;var s={js:function(o,e,t){var r=document.createElement("script");document.head.appendChild(r),r.onload=function(){"function"==typeof e&&e()},r.onerror=function(){"function"==typeof t&&t()},r.type="text/javascript","string"==typeof o&&(r.src=o)},css:function(o,e,t){var r=document.createElement("link");document.head.appendChild(r),r.onload=function(){"function"==typeof e&&e()},r.onerror=function(){"function"==typeof t&&t()},r.rel="stylesheet",r.type="text/css","string"==typeof o&&(r.href=o)},resource:function(o,e,t,r){if("string"==typeof o&&"string"==typeof e){var n=new Loader;n.add(o,e,{loadType:1}).load(),n.onLoad.add(function(o,e){if(c[e.name]=e,"function"==typeof t){var r=(window.URL||window.webkitURL).createObjectURL(e.data);e.objectURL=r,t(e,r)}}),n.onError.add(function(o,e,t){console.log("error:",o.message),"function"==typeof r&&r()})}}};this.loaders=s,this.load=function(o){onceDocumentIsReady(function(){function a(){function i(){p===f&&(!0===Object.prototype.hasOwnProperty.call(u,"onLoad")&&u.onLoad(c),a())}if(void 0!==e&&(console.log(n.length),console.log(n[0]),r+=75/t,e.go(r)),n.length>=1)switch(shifted=n.shift(),shifted.type){case"js":l=shifted.entry;s.js(l.link,function(){!0===Object.prototype.hasOwnProperty.call(l,"onLoad")&&l.onLoad(),a()},function(){!0===Object.prototype.hasOwnProperty.call(l,"onError")&&l.onError(),a()});break;case"css":l=shifted.entry;s.css(l.link,function(){!0===Object.prototype.hasOwnProperty.call(l,"onLoad")&&l.onLoad(),a()},function(){!0===Object.prototype.hasOwnProperty.call(l,"onError")&&l.onError(),a()});break;case"resource":var l=shifted.entry;s.resource(l.name,l.link,function(o,e){!0===Object.prototype.hasOwnProperty.call(l,"onLoad")&&l.onLoad(o,e),a()},function(){!0===Object.prototype.hasOwnProperty.call(l,"onError")&&l.onError(),a()});break;case"parallel":var p=0,u=shifted.entries;!0===Object.prototype.hasOwnProperty.call(u,"js")&&(p+=u.js.length),!0===Object.prototype.hasOwnProperty.call(u,"css")&&(p+=u.css.length),!0===Object.prototype.hasOwnProperty.call(u,"resources")&&(p+=u.resources.length);var f=0;!0===Object.prototype.hasOwnProperty.call(u,"js")&&u.js.forEach(function(o,e,t){s.js(o,function(){f++,i()},function(){!0===Object.prototype.hasOwnProperty.call(u,"onError")&&u.onError()})}),!0===Object.prototype.hasOwnProperty.call(u,"css")&&u.css.forEach(function(o,e,t){s.css(o,function(){f++,i()},function(){!0===Object.prototype.hasOwnProperty.call(u,"onError")&&u.onError()})}),!0===Object.prototype.hasOwnProperty.call(u,"resources")&&u.resources.forEach(function(o,e,t){s.resource(o.name,o.link,function(o,e){f++,i()},function(){!0===Object.prototype.hasOwnProperty.call(u,"onError")&&u.onError()})});break;default:console.log("error","unknown TYPE of SHITED")}else"function"==typeof o&&o(c),void 0!==e&&e.go(100)}a()})}};"object"==typeof module?module.exports=new ladderized:"object"==typeof window&&(window.Ladderized=new ladderized);