...
(function(root){"use strict";var css=".nanobar{width:100%;height:4px;z-index:9999;top:0}.bar{width:0;height:100%;transition:height .3s;background:#000}";function addCss(){var s=document.getElementById("nanobarcss");if(s===null){s=document.createElement("style");s.type="text/css";s.id="nanobarcss";document.head.insertBefore(s,document.head.firstChild);if(!s.styleSheet)return s.appendChild(document.createTextNode(css));s.styleSheet.cssText=css}}function addClass(el,cls){if(el.classList)el.classList.add(cls);else el.className+=" "+cls}function createBar(rm){var el=document.createElement("div"),width=0,here=0,on=0,bar={el:el,go:go};addClass(el,"bar");function move(){var dist=width-here;if(dist<.1&&dist>-.1){place(here);on=0;if(width===100){el.style.height=0;setTimeout(function(){rm(el)},300)}}else{place(width-dist/4);setTimeout(go,16)}}function place(num){width=num;el.style.width=width+"%"}function go(num){if(num>=0){here=num;if(!on){on=1;move()}}else if(on){move()}}return bar}function Nanobar(opts){opts=opts||{};var el=document.createElement("div"),applyGo,nanobar={el:el,go:function(p){applyGo(p);if(p===100){init()}}};function rm(child){el.removeChild(child)}function init(){var bar=createBar(rm);el.appendChild(bar.el);applyGo=bar.go}addCss();addClass(el,"nanobar");if(opts.id)el.id=opts.id;if(opts.classname)addClass(el,opts.classname);if(opts.target){el.style.position="relative";opts.target.insertBefore(el,opts.target.firstChild)}else{el.style.position="fixed";document.getElementsByTagName("body")[0].appendChild(el)}init();return nanobar}if(typeof exports==="object"){module.exports=Nanobar}else if(typeof define==="function"&&define.amd){define([],function(){return Nanobar})}else{root.Nanobar=Nanobar}})(this);var ladderized=function(){var o,e=0,t=10;this.showNanoBar=function(){var e={classname:"ladderized-nanobar",id:"ladderized-nanobar",target:document.body};return o=new Nanobar(e),t=10,o.go(t),this};var r=[];this.queue=r,this.clearQueue=function(){return r=[],e=0,t=10,this},this.parallel=function(t){return void 0!==o&&e++,"object"!=typeof t&&console.log("error","expecting OBJECT on PARALLEL"),r.push({type:"parallel",entries:t}),this},this.js=function(t){return void 0!==o&&e++,"object"!=typeof t&&console.log("error","expecting OBJECT on JS"),!1===Object.prototype.hasOwnProperty.call(t,"link")&&console.log("error","expecting LINK PROPERTY on JS"),r.push({type:"js",entry:t}),this},this.css=function(t){return void 0!==o&&e++,"object"!=typeof t&&console.log("error","expecting OBJECT on CSS"),!1===Object.prototype.hasOwnProperty.call(t,"link")&&console.log("error","expecting LINK PROPERTY on CSS"),r.push({type:"css",entry:t}),this},this.resource=function(t){return void 0!==o&&e++,"object"!=typeof t&&console.log("error","expecting OBJECT on RESOURCE"),!1===Object.prototype.hasOwnProperty.call(t,"name")&&console.log("error","expecting NAME PROPERTY on RESOURCE"),!1===Object.prototype.hasOwnProperty.call(t,"link")&&console.log("error","expecting LINK PROPERTY on RESOURCE"),r.push({type:"resource",entry:t}),this};var n={};this.resources=n;var c={js:function(o,e,t){var r=document.createElement("script");document.head.appendChild(r),r.onload=function(){"function"==typeof e&&e()},r.onerror=function(){"function"==typeof t&&t()},r.type="text/javascript","string"==typeof o&&(r.src=o)},css:function(o,e,t){var r=document.createElement("link");document.head.appendChild(r),r.onload=function(){"function"==typeof e&&e()},r.onerror=function(){"function"==typeof t&&t()},r.rel="stylesheet",r.type="text/css","string"==typeof o&&(r.href=o)},resource:function(o,e,t,r){if("string"==typeof o&&"string"==typeof e){var c=new Loader;c.add(o,e,{loadType:1}).load(),c.onLoad.add(function(o,e){if(n[e.name]=e,"function"==typeof t){var r=(window.URL||window.webkitURL).createObjectURL(e.data);e.objectURL=r,t(e,r)}}),c.onError.add(function(o,e,t){console.log("error:",o.message),"function"==typeof r&&r()})}}};this.loaders=c,this.load=function(s){return onceDocumentIsReady(function(){function a(){function i(){l===f&&(!0===Object.prototype.hasOwnProperty.call(u,"onLoad")&&u.onLoad(n),a())}if(void 0!==o&&(t+=75/e,o.go(t)),r.length>=1)switch(shifted=r.shift(),shifted.type){case"js":p=shifted.entry;c.js(p.link,function(){!0===Object.prototype.hasOwnProperty.call(p,"onLoad")&&p.onLoad(),a()},function(){!0===Object.prototype.hasOwnProperty.call(p,"onError")&&p.onError(),a()});break;case"css":p=shifted.entry;c.css(p.link,function(){!0===Object.prototype.hasOwnProperty.call(p,"onLoad")&&p.onLoad(),a()},function(){!0===Object.prototype.hasOwnProperty.call(p,"onError")&&p.onError(),a()});break;case"resource":var p=shifted.entry;c.resource(p.name,p.link,function(o,e){!0===Object.prototype.hasOwnProperty.call(p,"onLoad")&&p.onLoad(o,e),a()},function(){!0===Object.prototype.hasOwnProperty.call(p,"onError")&&p.onError(),a()});break;case"parallel":var l=0,u=shifted.entries;!0===Object.prototype.hasOwnProperty.call(u,"js")&&(l+=u.js.length),!0===Object.prototype.hasOwnProperty.call(u,"css")&&(l+=u.css.length),!0===Object.prototype.hasOwnProperty.call(u,"resources")&&(l+=u.resources.length);var f=0;!0===Object.prototype.hasOwnProperty.call(u,"js")&&u.js.forEach(function(o,e,t){c.js(o,function(){f++,i()},function(){!0===Object.prototype.hasOwnProperty.call(u,"onError")&&u.onError()})}),!0===Object.prototype.hasOwnProperty.call(u,"css")&&u.css.forEach(function(o,e,t){c.css(o,function(){f++,i()},function(){!0===Object.prototype.hasOwnProperty.call(u,"onError")&&u.onError()})}),!0===Object.prototype.hasOwnProperty.call(u,"resources")&&u.resources.forEach(function(o,e,t){c.resource(o.name,o.link,function(o,e){f++,i()},function(){!0===Object.prototype.hasOwnProperty.call(u,"onError")&&u.onError()})});break;default:console.log("error","unknown TYPE of SHITED")}else"function"==typeof s&&s(n),void 0!==o&&o.go(100)}a()}),this}};"object"==typeof module?module.exports=new ladderized:"object"==typeof window&&(window.Ladderized=new ladderized);