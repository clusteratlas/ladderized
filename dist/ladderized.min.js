...
(function(root){"use strict";var css=".nanobar{width:100%;height:4px;z-index:9999;top:0}.bar{width:0;height:100%;transition:height .3s;background:#000}";function addCss(){var s=document.getElementById("nanobarcss");if(s===null){s=document.createElement("style");s.type="text/css";s.id="nanobarcss";document.head.insertBefore(s,document.head.firstChild);if(!s.styleSheet)return s.appendChild(document.createTextNode(css));s.styleSheet.cssText=css}}function addClass(el,cls){if(el.classList)el.classList.add(cls);else el.className+=" "+cls}function createBar(rm){var el=document.createElement("div"),width=0,here=0,on=0,bar={el:el,go:go};addClass(el,"bar");function move(){var dist=width-here;if(dist<.1&&dist>-.1){place(here);on=0;if(width===100){el.style.height=0;setTimeout(function(){rm(el)},300)}}else{place(width-dist/4);setTimeout(go,16)}}function place(num){width=num;el.style.width=width+"%"}function go(num){if(num>=0){here=num;if(!on){on=1;move()}}else if(on){move()}}return bar}function Nanobar(opts){opts=opts||{};var el=document.createElement("div"),applyGo,nanobar={el:el,go:function(p){applyGo(p);if(p===100){init()}}};function rm(child){el.removeChild(child)}function init(){var bar=createBar(rm);el.appendChild(bar.el);applyGo=bar.go}addCss();addClass(el,"nanobar");if(opts.id)el.id=opts.id;if(opts.classname)addClass(el,opts.classname);if(opts.target){el.style.position="relative";opts.target.insertBefore(el,opts.target.firstChild)}else{el.style.position="fixed";document.getElementsByTagName("body")[0].appendChild(el)}init();return nanobar}if(typeof exports==="object"){module.exports=Nanobar}else if(typeof define==="function"&&define.amd){define([],function(){return Nanobar})}else{root.Nanobar=Nanobar}})(this);var ladderized=function(){this.createNanoBar=function(){var o={classname:"ladderized-nanobar",id:"ladderized-nanobar",target:document.body};return new Nanobar(o)};var o=[];this.queue=o,this.clearQueue=function(){return o=[],this},this.parallel=function(e){return"object"!=typeof e&&console.log("error","expecting OBJECT on PARALLEL"),o.push({type:"parallel",entries:e}),this},this.js=function(e){return"object"!=typeof e&&console.log("error","expecting OBJECT on JS"),!1===Object.prototype.hasOwnProperty.call(e,"link")&&console.log("error","expecting LINK PROPERTY on JS"),o.push({type:"js",entry:e}),this},this.css=function(e){return"object"!=typeof e&&console.log("error","expecting OBJECT on CSS"),!1===Object.prototype.hasOwnProperty.call(e,"link")&&console.log("error","expecting LINK PROPERTY on CSS"),o.push({type:"css",entry:e}),this},this.resource=function(e){return"object"!=typeof e&&console.log("error","expecting OBJECT on RESOURCE"),!1===Object.prototype.hasOwnProperty.call(e,"name")&&console.log("error","expecting NAME PROPERTY on RESOURCE"),!1===Object.prototype.hasOwnProperty.call(e,"link")&&console.log("error","expecting LINK PROPERTY on RESOURCE"),o.push({type:"resource",entry:e}),this};var e={};this.resources=e;var t={js:function(o,e,t){var r=document.createElement("script");document.head.appendChild(r),r.onload=function(){"function"==typeof e&&e()},r.onerror=function(){"function"==typeof t&&t()},r.type="text/javascript","string"==typeof o&&(r.src=o)},css:function(o,e,t){var r=document.createElement("link");document.head.appendChild(r),r.onload=function(){"function"==typeof e&&e()},r.onerror=function(){"function"==typeof t&&t()},r.rel="stylesheet",r.type="text/css","string"==typeof o&&(r.href=o)},resource:function(o,t,r,n){if("string"==typeof o&&"string"==typeof t){var c=new Loader;c.add(o,t,{loadType:1}).load(),c.onLoad.add(function(o,t){if(e[t.name]=t,"function"==typeof r){var n=(window.URL||window.webkitURL).createObjectURL(t.data);t.objectURL=n,r(t,n)}}),c.onError.add(function(o,e,t){console.log("error:",o.message),"function"==typeof n&&n()})}}};this.loaders=t,this.load=function(r){onceDocumentIsReady(function(){function n(){function c(){a===i&&(!0===Object.prototype.hasOwnProperty.call(p,"onLoad")&&p.onLoad(e),n())}if(o.length>=1)switch(shifted=o.shift(),shifted.type){case"js":s=shifted.entry;t.js(s.link,function(){!0===Object.prototype.hasOwnProperty.call(s,"onLoad")&&s.onLoad(),n()},function(){!0===Object.prototype.hasOwnProperty.call(s,"onError")&&s.onError(),n()});break;case"css":s=shifted.entry;t.css(s.link,function(){!0===Object.prototype.hasOwnProperty.call(s,"onLoad")&&s.onLoad(),n()},function(){!0===Object.prototype.hasOwnProperty.call(s,"onError")&&s.onError(),n()});break;case"resource":var s=shifted.entry;t.resource(s.name,s.link,function(o,e){!0===Object.prototype.hasOwnProperty.call(s,"onLoad")&&s.onLoad(o,e),n()},function(){!0===Object.prototype.hasOwnProperty.call(s,"onError")&&s.onError(),n()});break;case"parallel":var a=0,p=shifted.entries;!0===Object.prototype.hasOwnProperty.call(p,"js")&&(a+=p.js.length),!0===Object.prototype.hasOwnProperty.call(p,"css")&&(a+=p.css.length),!0===Object.prototype.hasOwnProperty.call(p,"resources")&&(a+=p.resources.length);var i=0;!0===Object.prototype.hasOwnProperty.call(p,"js")&&p.js.forEach(function(o,e,r){t.js(o,function(){i++,c()},function(){!0===Object.prototype.hasOwnProperty.call(p,"onError")&&p.onError()})}),!0===Object.prototype.hasOwnProperty.call(p,"css")&&p.css.forEach(function(o,e,r){t.css(o,function(){i++,c()},function(){!0===Object.prototype.hasOwnProperty.call(p,"onError")&&p.onError()})}),!0===Object.prototype.hasOwnProperty.call(p,"resources")&&p.resources.forEach(function(o,e,r){t.resource(o.name,o.link,function(o,e){i++,c()},function(){!0===Object.prototype.hasOwnProperty.call(p,"onError")&&p.onError()})});break;default:console.log("error","unknown TYPE of SHITED")}else"function"==typeof r&&r(e)}n()})}};"object"==typeof module?module.exports=new ladderized:"object"==typeof window&&(window.Ladderized=new ladderized);