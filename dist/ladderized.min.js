...
!function(t,e){function n(){if(!a){a=!0;for(var t=0;t<d.length;t++)d[t].fn.call(window,d[t].ctx);d=[]}}function o(){"complete"===document.readyState&&n()}t=t||"onceDocumentIsReady",e=e||window;var d=[],a=!1,c=!1;e[t]=function(t,e){return a?void setTimeout(function(){t(e)},1):(d.push({fn:t,ctx:e}),void("complete"===document.readyState?setTimeout(n,1):c||(document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):(document.attachEvent("onreadystatechange",o),window.attachEvent("onload",n)),c=!0)))}}("onceDocumentIsReady",window);
(function(root){"use strict";var css=".nanobar{width:100%;height:4px;z-index:9999;top:0}.bar{width:0;height:100%;transition:height .3s;background:#000}";function addCss(){var s=document.getElementById("nanobarcss");if(s===null){s=document.createElement("style");s.type="text/css";s.id="nanobarcss";document.head.insertBefore(s,document.head.firstChild);if(!s.styleSheet)return s.appendChild(document.createTextNode(css));s.styleSheet.cssText=css}}function addClass(el,cls){if(el.classList)el.classList.add(cls);else el.className+=" "+cls}function createBar(rm){var el=document.createElement("div"),width=0,here=0,on=0,bar={el:el,go:go};addClass(el,"bar");function move(){var dist=width-here;if(dist<.1&&dist>-.1){place(here);on=0;if(width===100){el.style.height=0;setTimeout(function(){rm(el)},300)}}else{place(width-dist/4);setTimeout(go,16)}}function place(num){width=num;el.style.width=width+"%"}function go(num){if(num>=0){here=num;if(!on){on=1;move()}}else if(on){move()}}return bar}function Nanobar(opts){opts=opts||{};var el=document.createElement("div"),applyGo,nanobar={el:el,go:function(p){applyGo(p);if(p===100){init()}}};function rm(child){el.removeChild(child)}function init(){var bar=createBar(rm);el.appendChild(bar.el);applyGo=bar.go}addCss();addClass(el,"nanobar");if(opts.id)el.id=opts.id;if(opts.classname)addClass(el,opts.classname);if(opts.target){el.style.position="relative";opts.target.insertBefore(el,opts.target.firstChild)}else{el.style.position="fixed";document.getElementsByTagName("body")[0].appendChild(el)}init();return nanobar}if(typeof exports==="object"){module.exports=Nanobar}else if(typeof define==="function"&&define.amd){define([],function(){return Nanobar})}else{root.Nanobar=Nanobar}})(this);var ladderized=function(){this.createNanoBar=function(e){"number"!=typeof e&&console.log("error","createNanoBar stepCount must be a number!");var o={classname:"ladderized-nanobar",id:"ladderized-nanobar",target:document.body},t=new Nanobar(o);return this.currentValue=0,this.stepCount=e,this.nanobar=t,this};var e=[];this.queue=e,this.setStepCount=function(e){return"number"!=typeof e&&console.log("error","createNanoBar stepCount must be a number!"),this.stepCount=e,this},this.clearQueue=function(){return e=[],this},this.parallel=function(o){return"object"!=typeof o&&console.log("error","expecting OBJECT on PARALLEL"),e.push({type:"parallel",entries:o}),this},this.js=function(o){return"object"!=typeof o&&console.log("error","expecting OBJECT on JS"),!1===Object.prototype.hasOwnProperty.call(o,"link")&&console.log("error","expecting LINK PROPERTY on JS"),e.push({type:"js",entry:o}),this},this.css=function(o){return"object"!=typeof o&&console.log("error","expecting OBJECT on CSS"),!1===Object.prototype.hasOwnProperty.call(o,"link")&&console.log("error","expecting LINK PROPERTY on CSS"),e.push({type:"css",entry:o}),this},this.resource=function(o){return"object"!=typeof o&&console.log("error","expecting OBJECT on RESOURCE"),!1===Object.prototype.hasOwnProperty.call(o,"name")&&console.log("error","expecting NAME PROPERTY on RESOURCE"),!1===Object.prototype.hasOwnProperty.call(o,"link")&&console.log("error","expecting LINK PROPERTY on RESOURCE"),e.push({type:"resource",entry:o}),this};var o={};this.resources=o;var t={js:function(e,o,t){var r=document.createElement("script");document.head.appendChild(r),r.onload=function(){"function"==typeof o&&o()},r.onerror=function(){"function"==typeof t&&t()},r.type="text/javascript","string"==typeof e&&(r.src=e)},css:function(e,o,t){var r=document.createElement("link");document.head.appendChild(r),r.onload=function(){"function"==typeof o&&o()},r.onerror=function(){"function"==typeof t&&t()},r.rel="stylesheet",r.type="text/css","string"==typeof e&&(r.href=e)},resource:function(e,t,r,n){if("string"==typeof e&&"string"==typeof t){var c=new Loader;c.add(e,t,{loadType:1}).load(),c.onLoad.add(function(e,t){if(o[t.name]=t,"function"==typeof r){var n=(window.URL||window.webkitURL).createObjectURL(t.data);t.objectURL=n,r(t,n)}}),c.onError.add(function(e,o,t){console.log("error:",e.message),"function"==typeof n&&n()})}}};this.loaders=t,this.load=function(r){var n=this;onceDocumentIsReady(function(){function c(){void 0!==n.nanobar&&(n.currentValue>=100-100/n.stepCount?n.currentValue=100:n.currentValue+=100/n.stepCount,n.nanobar.go(n.currentValue))}function s(){function n(){i===l&&(!0===Object.prototype.hasOwnProperty.call(p,"onLoad")&&p.onLoad(o),s())}if(e.length>=1)switch(shifted=e.shift(),shifted.type){case"js":a=shifted.entry;t.js(a.link,function(){!0===Object.prototype.hasOwnProperty.call(a,"onLoad")&&a.onLoad(),c(),s()},function(){!0===Object.prototype.hasOwnProperty.call(a,"onError")&&a.onError(),c(),s()});break;case"css":a=shifted.entry;t.css(a.link,function(){!0===Object.prototype.hasOwnProperty.call(a,"onLoad")&&a.onLoad(),c(),s()},function(){!0===Object.prototype.hasOwnProperty.call(a,"onError")&&a.onError(),c(),s()});break;case"resource":var a=shifted.entry;t.resource(a.name,a.link,function(e,o){!0===Object.prototype.hasOwnProperty.call(a,"onLoad")&&a.onLoad(e,o),c(),s()},function(){!0===Object.prototype.hasOwnProperty.call(a,"onError")&&a.onError(),c(),s()});break;case"parallel":var i=0,p=shifted.entries;!0===Object.prototype.hasOwnProperty.call(p,"js")&&(i+=p.js.length),!0===Object.prototype.hasOwnProperty.call(p,"css")&&(i+=p.css.length),!0===Object.prototype.hasOwnProperty.call(p,"resources")&&(i+=p.resources.length);var l=0;!0===Object.prototype.hasOwnProperty.call(p,"js")&&p.js.forEach(function(e,o,r){t.js(e,function(){l++,n()},function(){!0===Object.prototype.hasOwnProperty.call(p,"onError")&&p.onError()})}),!0===Object.prototype.hasOwnProperty.call(p,"css")&&p.css.forEach(function(e,o,r){t.css(e,function(){l++,n()},function(){!0===Object.prototype.hasOwnProperty.call(p,"onError")&&p.onError()})}),!0===Object.prototype.hasOwnProperty.call(p,"resources")&&p.resources.forEach(function(e,o,r){t.resource(e.name,e.link,function(e,o){l++,n()},function(){!0===Object.prototype.hasOwnProperty.call(p,"onError")&&p.onError()})});break;default:console.log("error","unknown TYPE of SHITED")}else"function"==typeof r&&r(o)}s()})}};"object"==typeof module?module.exports=new ladderized:"object"==typeof window&&(window.Ladderized=new ladderized);